...
<body>
  ...
  <div class="container mt-5">
    ...
    <p>Explore our website to learn more about our products, research initiatives, career opportunities, and how we're making a difference in healthcare.</p>
      ...
      <div class="col-md-4">
        <img src="/static/pharma_img.jpeg" class="img-fluid" alt="Pharmacy Image">
      </div>
    </div>
  </div>
  <body background="/static/bg_img.jpeg" style="background-repeat: no-repeat; background-size: cover;">


  <!-- Footer -->
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 Your Trusted Health Partner: PharmaCompany All rights reserved.</p>
    <p>DEVELOPED BY JAYAHARI E (212221040065))</p>
  </footer>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="/static/Screenshot 2024-05-19 174836.png" class="card-img-top" alt="Product 1" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="/static/Screenshot 2024-05-19 174906.png" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="/static/Screenshot 2024-05-19 174916.png" class="card-img-top" alt="Product 3" width="200" height="200">
            <div class="card-body">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <address>
          ...
          12/36, Sai Nagar, GKM Colony<br>
          TN, 632007<br><br>
          <strong>Email:</strong><br>
          jayahari@pharmamed.com<br><br>
...
![alt text](<Screenshot 2024-05-19 175333.png>)
![alt text](<Screenshot 2024-05-19 175355.png>)
![alt text](<Screenshot 2024-05-19 175428.png>)
